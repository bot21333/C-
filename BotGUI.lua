...
do
	...
	function library.Functions.Draggable(Frame) 
		local dragToggle
		local dragSpeed = .25
		local dragInput
		local dragStart
...
do
	...
	function library:new(): table
		...
		do
			...
			library.Functions.Tween(ScreenGui.Frame, { Size = UDim2.new(0, 240, 0, 175) }, 0.2).Completed:Wait()
		...
		library.Functions.DraggingEnabled(ScreenGui.Frame)
		library.Functions.Draggable(ScreenGui.Frame)
		...
		library.Functions.Tween(ScreenGui.Frame, { Size = UDim2.new(0, 500, 0, 280) }, 0.2).Completed:Wait()
...
ImageButton.Image = "http://www.roblox.com/asset/?id=15617446791"
