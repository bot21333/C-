...
local L_3_ = {
	...
	[54] = function()
		local L_1154_, L_1155_, L_1156_, L_1157_, L_1158_ = L_2_(54)
		return {
			Name = "Dark Violet",
	...
	[55] = function()
		local L_1159_, L_1160_, L_1161_, L_1162_, L_1163_ = L_2_(55)
		return {
			Name = "Blue",
	...
	[56] = function()
		local L_1164_, L_1165_, L_1166_, L_1167_, L_1168_ = L_2_(56)
		return {
			Name = "Vampire",
	...
	[57] = function()
		local L_1169_, L_1170_, L_1171_, L_1172_, L_1173_ = L_2_(57)
		return {
			Name = "Rainbow",
	...
	[58] = function()
		local L_1174_, L_1175_, L_1176_, L_1177_, L_1178_ = L_2_(58)
		return {
			Name = "Luffy",
	...
	[59] = function()
		local L_1179_, L_1180_, L_1181_, L_1182_, L_1183_ = L_2_(59)
		return {
			Name = "Green",
	...
	[60] = function()
		local L_1184_, L_1185_, L_1186_, L_1187_, L_1188_ = L_2_(60)
		return {
			Name = "Black",
...
do
	local L_1189_, L_1190_, L_1191_, L_1192_, L_1193_, L_1194_, L_1195_, L_1196_, L_1197_, L_1198_, L_1199_, L_1200_, L_1201_, L_1202_, L_1203_, L_1204_ = task, setmetatable, error, newproxy, getmetatable, next, table, unpack, coroutine, script, type, require, pcall, getfenv, setfenv, rawget
	local L_1205_, L_1206_, L_1207_, L_1208_, L_1209_, L_1210_, L_1211_, L_1212_, L_1213_, L_1214_, L_1215_ = L_1195_.insert, L_1195_.remove, L_1195_.freeze or function(L_1222_arg0)
		return L_1222_arg0
	end, L_1189_ and L_1189_.defer or function(L_1223_arg0, ...)
		local L_1224_ = L_1197_.create(L_1223_arg0)
		L_1197_.resume(L_1224_, ...)
		return L_1224_
	end, '0.0.0-venv', {}, {}, {}, {}, {}, {}
	local L_1216_, L_1217_ = {
		GetChildren = function(L_1225_arg0)
			local L_1226_, L_1227_ = L_1215_[L_1225_arg0], {}
			for L_1228_forvar0 in L_1194_, L_1226_ do
				L_1205_(L_1227_, L_1228_forvar0)
			end
			return L_1227_
		end,
		FindFirstChild = function(L_1229_arg0, L_1230_arg1)
			if not L_1230_arg1 then
				L_1191_('Argument 1 missing or nil', 2)
			end
			for L_1231_forvar0 in L_1194_, L_1215_[L_1229_arg0] do
				if L_1231_forvar0.Name == L_1230_arg1 then
					return L_1231_forvar0
				end
			end
			return
		end,
		GetFullName = function(L_1232_arg0)
			local L_1233_, L_1234_ = L_1232_arg0.Name, L_1232_arg0.Parent
			while L_1234_ do
				L_1233_ = L_1234_.Name .. '.' .. L_1233_
				L_1234_ = L_1234_.Parent
			end
			return 'VirtualEnv.' .. L_1233_
		end
	}, {}
	for L_1235_forvar0, L_1236_forvar1 in L_1194_, L_1216_ do
		L_1217_[L_1235_forvar0] = function(L_1237_arg0, ...)
			if not L_1215_[L_1237_arg0] then
				L_1191_("Expected ':' not '.' calling member function " .. L_1235_forvar0, 1)
			end
			return L_1236_forvar1(L_1237_arg0, ...)
		end
	end
	local L_1218_ = function(L_1238_arg0, L_1239_arg1, L_1240_arg2)
		local L_1241_, L_1242_, L_1243_, L_1244_, L_1245_ = L_1190_({}, {
			__mode = 'k'
		}), function(L_1247_arg0)
			L_1191_(L_1247_arg0 .. ' is not a valid (virtual) member of ' .. L_1238_arg0 .. ' "' .. L_1239_arg1 .. '"', 1)
		end, function(L_1248_arg0)
			L_1191_('Unable to assign (virtual) property ' .. L_1248_arg0 .. '. Property is read only', 1)
		end, (L_1192_(true))
		local L_1246_ = L_1193_(L_1244_)
		L_1246_.__index = function(L_1249_arg0, L_1250_arg1)
			if L_1250_arg1 == 'ClassName' then
				return L_1238_arg0
			elseif L_1250_arg1 == 'Name' then
				return L_1239_arg1
			elseif L_1250_arg1 == 'Parent' then
				return L_1240_arg2
			elseif L_1238_arg0 == 'StringValue' and L_1250_arg1 == 'Value' then
				return L_1245_
			else
				local L_1251_ = L_1217_[L_1250_arg1]
				if L_1251_ then
					return L_1251_
				end
			end
			for L_1252_forvar0 in L_1194_, L_1241_ do
				if L_1252_forvar0.Name == L_1250_arg1 then
					return L_1252_forvar0
				end
			end
			L_1242_(L_1250_arg1)
		end
		L_1246_.__newindex = function(L_1253_arg0, L_1254_arg1, L_1255_arg2)
			if L_1254_arg1 == 'ClassName' then
				L_1243_(L_1254_arg1)
			elseif L_1254_arg1 == 'Name' then
				L_1239_arg1 = L_1255_arg2
			elseif L_1254_arg1 == 'Parent' then
				if L_1255_arg2 == L_1244_ then
					return
				end
				if L_1240_arg2 ~= nil then
					L_1215_[L_1240_arg2][L_1244_] = nil
				end
				L_1240_arg2 = L_1255_arg2
				if L_1255_arg2 ~= nil then
					L_1215_[L_1255_arg2][L_1244_] = true
				end
			elseif L_1238_arg0 == 'StringValue' and L_1254_arg1 == 'Value' then
				L_1245_ = L_1255_arg2
			else
				L_1242_(L_1254_arg1)
			end
		end
		L_1246_.__tostring = function()
			return L_1239_arg1
		end
		L_1215_[L_1244_] = L_1241_
		if L_1240_arg2 ~= nil then
			L_1215_[L_1240_arg2][L_1244_] = true
		end
		return L_1244_
	end
	local function L_1219_func(L_1256_arg0, L_1257_arg1)
		local L_1258_, L_1259_, L_1260_, L_1261_ = L_1256_arg0[1], L_1256_arg0[2], L_1256_arg0[3], L_1256_arg0[4]
		local L_1262_ = L_1206_(L_1260_, 1)
		local L_1263_ = L_1218_(L_1259_, L_1262_, L_1257_arg1)
		L_1210_[L_1258_] = L_1263_
		if L_1260_ then
			for L_1264_forvar0, L_1265_forvar1 in L_1194_, L_1260_ do
				L_1263_[L_1264_forvar0] = L_1265_forvar1
			end
		end
		if L_1261_ then
			for L_1266_forvar0, L_1267_forvar1 in L_1194_, L_1261_ do
				L_1219_func(L_1267_forvar1, L_1263_)
			end
		end
		return L_1263_
	end
	local L_1220_ = {}
	for L_1268_forvar0, L_1269_forvar1 in L_1194_, L_1_ do
		L_1205_(L_1220_, L_1219_func(L_1269_forvar1))
	end
	for L_1270_forvar0, L_1271_forvar1 in L_1194_, L_3_ do
		local L_1272_ = L_1210_[L_1270_forvar0]
		L_1211_[L_1272_] = L_1271_forvar1
		local L_1273_ = L_1272_.ClassName
		if L_1273_ == 'LocalScript' or L_1273_ == 'Script' then
			L_1205_(L_1213_, L_1272_)
		end
	end
	local L_1221_ = function(L_1274_arg0)
		local L_1275_, L_1276_ = L_1274_arg0.ClassName, L_1212_[L_1274_arg0]
		if L_1276_ and L_1275_ == 'ModuleScript' then
			return L_1196_(L_1276_)
		end
		local L_1277_ = L_1211_[L_1274_arg0]
		if not L_1277_ then
			return
		end
		if L_1275_ == 'LocalScript' or L_1275_ == 'Script' then
			L_1277_()
			return
		else
			local L_1278_ = {
			...
			L_1212_[L_1274_arg0] = L_1278_
			return L_1196_(L_1278_)
		end
	end
	function L_2_(L_1279_arg0)
		local L_1280_ = L_1210_[L_1279_arg0]
		local L_1281_ = L_1211_[L_1280_]
		if not L_1281_ then
			return
		end
		local L_1282_, L_1283_, L_1284_, L_1285_, L_1286_, L_1287_, L_1288_ = false, L_1207_{
			Version = L_1209_,
			Script = L_1198_,
			Shared = L_1214_,
			GetScript = function()
		...
		}, L_1280_, function(L_1291_arg0, ...)
			if L_1215_[L_1291_arg0] and L_1291_arg0.ClassName == 'ModuleScript' and L_1211_[L_1291_arg0] then
				return L_1221_(L_1291_arg0)
			end
			return L_1200_(L_1291_arg0, ...)
		end
		local L_1289_, L_1290_ = function(L_1292_arg0, ...)
			if not L_1282_ then
				L_1288_()
			end
			if L_1199_(L_1292_arg0) == 'number' and L_1292_arg0 >= 0 then
				if L_1292_arg0 == 0 then
					return L_1287_
				else
					L_1292_arg0 = L_1292_arg0 + 1
					local L_1293_, L_1294_ = L_1201_(L_1202_, L_1292_arg0)
					if L_1293_ and L_1294_ == L_1286_ then
						return L_1287_
					end
				end
			end
			return L_1202_(L_1292_arg0, ...)
		end, function(L_1295_arg0, L_1296_arg1, ...)
			if not L_1282_ then
				L_1288_()
			end
			if L_1199_(L_1295_arg0) == 'number' and L_1295_arg0 >= 0 then
				if L_1295_arg0 == 0 then
					return L_1203_(L_1287_, L_1296_arg1)
				else
					L_1295_arg0 = L_1295_arg0 + 1
					local L_1297_, L_1298_ = L_1201_(L_1202_, L_1295_arg0)
					if L_1297_ and L_1298_ == L_1286_ then
						return L_1203_(L_1287_, L_1296_arg1)
					end
				end
			end
			return L_1203_(L_1295_arg0, L_1296_arg1, ...)
		end
		function L_1288_()
			L_1286_ = L_1202_(0)
			local L_1299_ = {
			...
			L_1287_ = L_1190_({}, {
				__index = function(L_1300_arg0, L_1301_arg1)
					local L_1302_ = L_1204_(L_1287_, L_1301_arg1)
					if L_1302_ ~= nil then
						return L_1302_
					end
					local L_1303_ = L_1299_[L_1301_arg1]
					if L_1303_ ~= nil then
						return L_1303_
					end
					return L_1286_[L_1301_arg1]
				end
			})
			L_1203_(L_1281_, L_1287_)
			L_1282_ = true
		end
		return L_1283_, L_1284_, L_1285_, L_1289_, L_1290_
	end
	for L_1304_forvar0, L_1305_forvar1 in L_1194_, L_1213_ do
		L_1208_(L_1221_, L_1305_forvar1)
	end
	do
		local L_1306_
		for L_1307_forvar0, L_1308_forvar1 in L_1194_, L_1220_ do
			if L_1308_forvar1.ClassName == 'ModuleScript' and L_1308_forvar1.Name == 'MainModule' then
				L_1306_ = L_1308_forvar1
				break
			end
		end
		if L_1306_ then
			return L_1221_(L_1306_)
		end
	end
end
