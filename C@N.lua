...
if game.Workspace._WorldOrigin.Locations:FindFirstChild('Mirage Island') then
    ...
    local url = "https://discord.com/api/webhooks/1182814680767529110/0ig6aOQ4ZMWp0EYAwAxJHRDuRjvDLqHq1B-dtir7W0VZkUQpiZHdyR2VRy_rRY3VI_Ye"                                                                                                                
    local data = {
    ...
    local url = "https://discord.com/api/webhooks/1182814908660858950/ITFHMRvR41YOu2u5jjtWKsrKR7da4VsJffBiHNk7PJuTkFYpwUpDv2C9pBaX9SLgSjqj"                                                                                                               
    local data = {
        ["username"] = 'Speed Hub X',                                                                                                                                                                                                          
